...
const ARCHIVE_COLUMN_LABELS: Record<string, string> = {
  ...
  worksite_code: "Código da obra",
  worksite_name: "Nome da obra",
  worksite_active: "Obra ativa",
  batch_start_date: "Início do lote",
  batch_end_date: "Fim do lote",
  batch_weekdays: "Dias da semana do lote",
  batch_entry_time: "Entrada definida no lote",
  batch_departure_time: "Saída definida no lote",
  batch_needs_snack: "Lanche definido no lote",
  batch_needs_transport: "Transporte definido no lote",
  batch_order_number: "Ordem do lote",
  batch_service_description: "Serviço definido no lote",
  batch_observation: "Observação do lote",
  batch_created_by_user_id: "ID de quem criou o lote",
  batch_created_by_name: "Lote criado por",
  batch_created_by_email: "E-mail de quem criou o lote",
  batch_created_at: "Lote criado em",
  batch_updated_at: "Lote atualizado em",
};
