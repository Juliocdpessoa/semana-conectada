...
export function StatusPill({ status }: { status: string }) {
  const map: Record<string, string> = {
    ...
    "PT ENVIADA PARA ASSINATURA": "border-sky-500/40 bg-sky-500/10 text-sky-700 dark:text-sky-300",
    "PT PRÉ-EMITIDA": "border-cyan-500/40 bg-cyan-500/10 text-cyan-700 dark:text-cyan-300",
  ...
  const dotMap: Record<string, string> = {
    ...
    "PT ENVIADA PARA ASSINATURA": "bg-sky-500",
    "PT PRÉ-EMITIDA": "bg-cyan-500",
