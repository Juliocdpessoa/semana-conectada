...
BEGIN
  ...
  UPDATE public.activities
     SET status = p_status,
         justification = CASE WHEN v_is_operation THEN activities.justification ELSE v_justification END,
         observation = CASE WHEN v_is_operation THEN activities.observation ELSE p_observation END,
         planning_data = CASE
