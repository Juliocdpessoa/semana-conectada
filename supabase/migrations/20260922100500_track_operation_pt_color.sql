...
BEGIN
  ...
  IF (planning_user AND old_business IS DISTINCT FROM new_business)
     OR (operation_user AND color_changed)
    ...
    INSERT INTO public.activity_history(
      ...
      (CASE
        ...
        WHEN operation_user AND color_changed THEN 'operation'
        ELSE 'individual'
...
-- Habilita atualização automática entre sessões quando ainda não configurada.
DO $$
BEGIN
